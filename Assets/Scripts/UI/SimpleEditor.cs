...
namespace HolofairStudio
{
    public class SimpleEditor : MonoBehaviour
    {
        ...
        [SerializeField]
        private Toggle m_snapXToggle = null;

        [SerializeField]
        private Toggle m_snapYToggle = null;

        [SerializeField]
        private Toggle m_snapZToggle = null;

        [SerializeField]
        private Button m_invertButton = null;
        ...
        {
            m_editor.Tools.Current = RuntimeTool.SnapY;
        }
